            ...
            for (var i = 0; i < formInfoCount.length; i++) { //todo move to switch.
                ...
                try {
                    if (formInfoCount[i].type !== "submit" && formInfoCount[i].type !== "hidden" && formInfoCount[i].type !== "checkbox") { //todo move to switch
                        ...
                        data.append("_m-" + i, __(formInfoCount[i].id + "-l").innerHTML || formInfoCount[i].labels[0].innerHTML + ": " + formInfoCount[i].value);
                        console.log("_m-" + i + " - " + __(formInfoCount[i].id + "-l").innerHTML || formInfoCount[i].labels[0].innerHTML + ": " + formInfoCount[i].value);
                    } else if (formInfoCount[i].type === "checkbox") {
                        data.append("_m-" + i, __(formInfoCount[i].id + "-l").innerHTML || formInfoCount[i].labels[0].innerHTML + ": " + (formInfoCount[i].checked ? "Yes" : "No"));
